<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:62:"E:\2038050325\maccms/application/admin\view\urlsend\index.html";i:1647767725;s:60:"E:\2038050325\maccms\application\admin\view\public\head.html";i:1647767725;s:60:"E:\2038050325\maccms\application\admin\view\public\foot.html";i:1647767725;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="page-container p10">
    ...
    <form class="layui-form layui-form-pane" method="post" action="" target="_blank" id="form_post">
        ...
        <div class="layui-form-item">
            <label class="layui-form-label"><?php echo lang('admin/urlsend/send_range'); ?>：</label>
            <div class="layui-input-inline">
                <div class="layui-input-inline w300">
                    <input type="radio" name="range" value="0" title="<?php echo lang('admin/urlsend/add_update'); ?>" checked >
                    <input type="radio" name="range" value="1" title="<?php echo lang('admin/urlsend/add'); ?>">
                </div>
            </div>
        </div>
